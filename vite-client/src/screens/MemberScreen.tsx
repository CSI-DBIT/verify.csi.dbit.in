...
import CertificateTableView from "./member-screen-components/CertificateTableView";
import MemberScreenSkeleton from "../components/MemberScreenSkeleton";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
const MemberScreen = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      fetchMemberData().then(() => setLoading(false)); // Set loading to false after data is fetched
  ...
  if (loading) {
    return <MemberScreenSkeleton />; // Display the loading skeleton while data is being fetched
  }
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage className="text-gray">Members</BreadcrumbPage>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
